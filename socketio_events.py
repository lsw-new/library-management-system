...
@socketio.on('connect')
# 逐行注释：定义 `handle_connect` 函数，封装一段可复用的后端处理流程。
def handle_connect():
...
# 逐行注释：定义 `handle_disconnect` 函数，封装一段可复用的后端处理流程。
...
# 逐行注释：定义 `handle_heartbeat` 函数，封装一段可复用的后端处理流程。
...
# 逐行注释：定义 `handle_join_books` 函数，封装一段可复用的后端处理流程。
...
# 逐行注释：定义 `handle_leave_books` 函数，封装一段可复用的后端处理流程。
